...
<body>
    <div class="container">
        ...
        <!-- 팝업 -->
        <!-- 작성창 -->
        <form name="dairy" id="dairy" method="get" action="#">
        <div class="write_page">
            ...
            <div class="write_page_box">
                ...
                <div class="write_content_all">
                    <p class="write_title"><input type="text" value="기분 좋아"></p>
                    ...
                    <p class="write_content"><textarea cols="35" rows="7" class="textarea"></textarea></p>
                </div>
            </div>
            <div class="write_page_img"></div>
            <div class="write_page_font"></div>
            <div class="write_page_sticker"></div>
            <div class="write_page_done"><img class="write_page_done_btn" src="../images/check-icon.png" alt="작성완료버튼"></div>
        </div>
        </form>
        <!-- 열람창 -->
