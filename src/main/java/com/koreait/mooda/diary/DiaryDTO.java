...
public class DiaryDTO {
	...
	public double getD_logitude() {
		return d_logitude;
	}
	public void setD_logitude(double d_logitude) {
		this.d_logitude = d_logitude;
	}
	...
	public String toString() {
		return "DiaryDTO [d_useridx=" + d_useridx + ", d_mood=" + d_mood + ", d_regdate=" + d_regdate + ", d_idx="
				...
				+ d_img + ", d_latitude=" + d_latitude + ", d_logitude=" + d_logitude + ", d_report=" + d_report + "]";
	}
